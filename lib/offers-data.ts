...
export const offers: Offer[] = [
  ...
  },
  {
    ...
    descriptionJp: 'たったの¥100',
    discount: '¥100 ONLY',
    validUntil: 'GVRYDAY MON - FRI',
    restrictions: 'Fruit Margarita + Chips & Guacamole | Chips & Pico de Gallo or | Only @ ¥100 | Regular Margarita + Chips & Pico de Gallo or | Chips & Guacamole',
