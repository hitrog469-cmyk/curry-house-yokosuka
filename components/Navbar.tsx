                    ...
                    <div className="absolute right-0 mt-2 w-72 max-w-[90vw] bg-white rounded-2xl shadow-2xl border border-gray-100 py-2 z-50 animate-fadeIn">
                      ...
                      <div className="py-1">
                        ...
                        {(user.role === 'staff' || user.role === 'admin') && (
                          <Link href="/staff/dashboard" onClick={() => setShowProfileMenu(false)} className="flex items-center gap-3 px-4 py-2.5 text-green-600 hover:bg-green-50 transition-colors">
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <div>
                              <span className="font-semibold">Staff Portal</span>
                              <span className="text-xs text-gray-400 block">Kitchen &middot; Delivery &middot; Tables</span>
                            </div>
                          </Link>
                        )}
                        ...
                        {user.role === 'admin' && (
                          ...
                          <Link href="/admin" onClick={() => setShowProfileMenu(false)} className="flex items-center gap-3 px-4 py-2.5 text-blue-600 hover:bg-blue-50 transition-colors">
                            ...
                            <div>
                              ...
                              <span className="text-xs text-gray-400 block">Orders &middot; Analytics</span>
                            </div>
                          </Link>
                          </>
                        )}
